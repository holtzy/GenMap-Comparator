...
You can use it trough the [**online version**](www.agap-sunshine.inra.fr/genmapcomp) and read the related publication in [**bioinformatics**](www.r-graph-gallery.com).  
